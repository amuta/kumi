...
RSpec.describe Kumi::Core::RubyParser::ExpressionConverter do
  ...
  describe "#ensure_syntax" do
    ...
    context "with custom objects" do
      ...
      it "raises error for objects that don't respond to to_ast_node" do
        ...
        end.to raise_error(Kumi::Core::Errors::SyntaxError, /Cannot convert/)
      end
    end
  end
  ...
  describe "#ref" do
    ...
    context "with invalid names" do
      it "raises error for non-symbol names" do
        ...
        end.to raise_error(Kumi::Core::Errors::SyntaxError, /Reference name must be a symbol/)
      end
  ...
  describe "#fn" do
    ...
    context "with invalid function names" do
      it "raises error for string function names" do
        ...
        end.to raise_error(Kumi::Core::Errors::SyntaxError, /Function name must be a symbol/)
      end
  ...
  describe "#input" do
    it "creates input proxy with context" do
      ...
      expect(result).to be_a(Kumi::Core::RubyParser::InputProxy)
  ...
  describe "private methods" do
    describe "#validate_reference_name" do
      ...
      it "rejects non-symbol names with descriptive error" do
        ...
        end.to raise_error(Kumi::Core::Errors::SyntaxError, error_message)
      end
    end

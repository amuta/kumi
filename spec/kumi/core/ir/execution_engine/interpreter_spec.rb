  ...
  describe ".run" do
    context "with scalar operations" do
      it "executes const operation" do
        ...
        result = described_class.run([ir], input: {}, runtime: { declaration_cache: {} }, accessors: {}, registry: registry)
      ...
      it "executes load_input for scalar" do
        ...
        result = described_class.run([ir], input: { x: 5 }, runtime: { declaration_cache: {} }, accessors: accessors, registry: registry)
    ...
    context "with vector operations" do
      it "executes load_input for vector with indices" do
        ...
        result = described_class.run([ir], input: {}, runtime: { declaration_cache: {} }, accessors: accessors, registry: registry)
    ...
    context "with error handling" do
      xit "includes operation context in error messages" do
        ...
        expect do
          described_class.run([ir], input: {}, runtime: { declaration_cache: {} }, accessors: {}, registry: registry)

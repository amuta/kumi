...
RSpec.describe Kumi::FunctionRegistry::CollectionFunctions do
  describe "collection queries" do
    it_behaves_like "a function with correct metadata", :empty?, 1, [Kumi::Types.array(:any)], :boolean
    it_behaves_like "a function with correct metadata", :size, 1, [Kumi::Types.array(:any)], :integer
  ...
  describe "element access" do
    it_behaves_like "a function with correct metadata", :first, 1, [Kumi::Types.array(:any)], :any
    it_behaves_like "a function with correct metadata", :last, 1, [Kumi::Types.array(:any)], :any
  ...
  describe "mathematical operations on collections" do
    it_behaves_like "a function with correct metadata", :sum, 1, [Kumi::Types.array(:float)], :float
    it_behaves_like "a function with correct metadata", :min, 1, [Kumi::Types.array(:float)], :float
    it_behaves_like "a function with correct metadata", :max, 1, [Kumi::Types.array(:float)], :float
  ...
  describe "collection operations" do
    ...
    it_behaves_like "a function with correct metadata", :reverse, 1, [Kumi::Types.array(:any)], Kumi::Types.array(:any)
    it_behaves_like "a function with correct metadata", :sort, 1, [Kumi::Types.array(:any)], Kumi::Types.array(:any)
    it_behaves_like "a function with correct metadata", :unique, 1, [Kumi::Types.array(:any)], Kumi::Types.array(:any)
    ...
    describe "reverse edge cases" do
      it "handles empty arrays" do
        fn = Kumi::FunctionRegistry.fetch(:reverse)
    ...
    describe "unique edge cases" do
      it "handles empty arrays" do
        fn = Kumi::FunctionRegistry.fetch(:unique)
        expect(fn.call([])).to eq([])
      end

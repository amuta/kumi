...
RSpec.describe Kumi::Core::FunctionRegistry::ConditionalFunctions do
  describe "conditional function" do
    ...
    describe "edge cases" do
      it "handles different return types" do
        fn = Kumi::Core::FunctionRegistry.fetch(:conditional)
  ...
  describe "if function" do
    ...
    describe "variable arity" do
      it "works with 2 arguments (condition and true value)" do
        fn = Kumi::Core::FunctionRegistry.fetch(:if)
  ...
  describe "coalesce function" do
    ...
    describe "variable arity" do
      it "works with single argument" do
        fn = Kumi::Core::FunctionRegistry.fetch(:coalesce)
  ...
  describe "conditional combinations" do
    it "can chain conditional operations" do
      conditional_fn = Kumi::Core::FunctionRegistry.fetch(:conditional)
      if_fn = Kumi::Core::FunctionRegistry.fetch(:if)
      coalesce_fn = Kumi::Core::FunctionRegistry.fetch(:coalesce)

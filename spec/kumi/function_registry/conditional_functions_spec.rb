...
RSpec.describe Kumi::Core::FunctionRegistry::ConditionalFunctions do
  describe "conditional function" do
    ...
    describe "edge cases" do
      it "handles different return types" do
        fn = Kumi::Registry.fetch(:conditional)
  ...
  describe "coalesce function" do
    ...
    describe "variable arity" do
      it "works with single argument" do
        fn = Kumi::Registry.fetch(:coalesce)
  ...
  describe "conditional combinations" do
    it "can chain conditional operations" do
      conditional_fn = Kumi::Registry.fetch(:conditional)
      if_fn = Kumi::Registry.fetch(:if)
      coalesce_fn = Kumi::Registry.fetch(:coalesce)

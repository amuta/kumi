...
module SimpleCascadeDebug
  ...
  schema skip_compiler: true do
    ...
    # Simple element-wise
    value :doubled, input.items.price * 2.0
...
begin
  ...
  analysis = IRTestHelper.get_analysis(SimpleCascadeDebug)
  ...
  result = IRTestHelper.compile_schema(SimpleCascadeDebug, debug: false)

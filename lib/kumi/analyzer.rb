...
module Kumi
  module Analyzer
    ...
    DEFAULT_PASSES = [
      ...
      Core::Analyzer::Passes::JoinReducePlanningPass,          # 19. Plans join/reduce operations and stores in node_index (Generates IR Structs)
      Core::Analyzer::Passes::ContractCheckPass,               # 20. Validates analyzer state contracts.

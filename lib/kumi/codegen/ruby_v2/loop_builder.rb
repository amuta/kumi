      ...
      module LoopBuilder
        ...
        def base_and_key_for_via(via, axis_order)
          ...
          when 1 then ["input", via[0]]
            ...
            [NameMangler.axis_var(parent_axis), via[-1]]
          end
        end
      end
    end

...
module Kumi
  module Dev
    module Golden
      ...
      REPRESENTATIONS = %w[ast nast snast lir_00_unoptimized lir_01_hoist_scalar_references_pass lir_02_inlined lir_03_cse lir_04_loop_invcm lir_05_const_prop
                           lir_01_hoist_scalar_references_pass generated_code].freeze

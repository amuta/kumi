// Autogenerated by Kumi Codegen for schema KUMI_f65a458d7141422c4327996869541c5b0c7c5023d0361cbf5a5fe43e48c329c6
export class KumiCompiledModule {
  ...
  get(name) {
    switch (name) {
      case 'shift_right_zero': return this._shift_right_zero();
      case 'shift_left_zero': return this._shift_left_zero();
      case 'shift_right_clamp': return this._shift_right_clamp();
      case 'shift_left_clamp': return this._shift_left_clamp();
      case 'shift_right_wrap': return this._shift_right_wrap();
      case 'shift_left_wrap': return this._shift_left_wrap();
      default: throw new Error(`Unknown declaration: ${name}`);
    }
  }

  _shift_right_zero(input = this.input) {
    let out = [];
    let t1 = input["cells"];
    let t4 = t1.length
    const t5 = 1;
  ...
  _shift_left_zero(input = this.input) {
    let out = [];
    let t18 = input["cells"];
    let t21 = t18.length
    const t22 = -1;
  ...
  _shift_right_clamp(input = this.input) {
    let out = [];
    let t35 = input["cells"];
    let t38 = t35.length
    const t39 = 1;
  ...
  _shift_left_clamp(input = this.input) {
    let out = [];
    let t46 = input["cells"];
    let t49 = t46.length
    const t50 = -1;
  ...
  _shift_right_wrap(input = this.input) {
    let out = [];
    let t57 = input["cells"];
    let t60 = t57.length
    const t61 = 1;
  ...
  _shift_left_wrap(input = this.input) {
    let out = [];
    let t67 = input["cells"];
    let t70 = t67.length
    const t71 = -1;
